...
const AddSellerModal = ({ onClose }: { onClose: () => void }) => {
  ...
  const handleSubmit = () => {
    ...
    // POST REQUEST TO ADD SELLER

    onClose(); // Close the modal
  };

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 w-full">
      {/* Modal Container */}
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Create a new seller</p>
          </div>
          <button
            onClick={onClose}
